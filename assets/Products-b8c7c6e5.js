...
`,Ho=({id:n,title:t,calories:i,onClick:r,onClickSuccess:e})=>{const[a,u]=m.useState(0),l=Me(),o={product_id:n,date:Cn(new Date,"yyyy-MM-dd"),weight:""},s=yn().shape({weight:Dn().max(700,"Weight should not exceed 700 grams").required("Weight is required").positive("Weight must be above zero")}),c=g=>{const x=i*g/100;return parseFloat(x)},d=(g,x)=>{const f=g.target.value,b=c(f);u(b),x("weight",Number(f)),x("calories",b)},v=(g,x)=>{e(),l(rn(g)),x.resetForm(),r()},p=()=>{r()};return h.jsxs(h.Fragment,{children:[h.jsx(nn,{}),h.jsx(On,{initialValues:o,validationSchema:s,onSubmit:v,children:({values:g,errors:x,touched:f,setFieldValue:b})=>h.jsx(In,{autoComplete:"off",children:h.jsxs(Do,{children:[h.jsxs(Oo,{children:[h.jsx("div",{children:h.jsx("label",{htmlFor:"product",children:h.jsx(Io,{name:"product",type:"text",value:t,readOnly:!0})})}),h.jsxs("div",{children:[h.jsxs(Ao,{htmlFor:"weight",children:[h.jsx(Mo,{name:"weight",type:"text",onChange:F=>d(F,b),onKeyPress:F=>{/^[0-9\b]+$/.test(F.key)||F.preventDefault()},value:g.weight,border:x.weight&&f.weight&&"1px solid #D80027"}),h.jsx(Vo,{children:"grams"})]}),h.jsx(Bo,{name:"weight",component:"p"})]})]}),h.jsxs(Po,{children:["Calories: ",h.jsx(Lo,{children:a})]}),h.jsxs(Ro,{children:[h.jsx(ko,{type:"submit",children:"Add to diary"}),h.jsx(To,{type:"button",onClick:p,children:"Cancel"})]})]})})})]})},jo=M.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,_o="/PowerPulse2.0/assets/avocado-d29ef327.png",Go=({onClick:n})=>{const t=z(an);return h.jsxs(jo,{children:[h.jsx($o,{src:_o,alt:"avocado",loading:"lazy"}),h.jsx(zo,{children:"Well done"}),h.jsxs(Uo,{children:["Calories: ",h.jsx("span",{children:t==null?void 0:t.calories})]}),h.jsx(No,{type:"button",onClick:()=>n(),children:"Next product"}),h.jsxs(Wo,{to:"/diary",children:[h.jsx("span",{children:"To the dairy"}),h.jsx("svg",{children:h.jsx("use",{href:`${re}#icon-arrow`})})]})]})},Yo=M.li`
  min-width: 280px;
  padding: 15px;
...
`,na=({id:n,title:t,calories:i,category:r,weight:e,recommended:a})=>{const[u,l]=m.useState(!1),[o,s]=m.useState(!1);console.log("recommended",a);const c=()=>{l(v=>!v)},d=()=>{s(v=>!v)};return h.jsxs(Yo,{children:[u&&h.jsx(ze,{onClick:c,children:h.jsx(Ho,{id:n,title:t,calories:i,onClick:c,onClickSuccess:d})}),o&&h.jsx(ze,{onClick:d,children:h.jsx(Go,{onClick:d})}),h.jsxs("section",{children:[h.jsxs(qo,{children:[h.jsx(Ko,{children:h.jsx("p",{children:"DIET"})}),h.jsxs(Xo,{color:`${a}`,children:[h.jsx("div",{}),h.jsx("p",{children:a?"Recommended":"Not recommended"}),h.jsxs(Qo,{type:"button",onClick:c,children:[h.jsx("span",{children:"Add"}),h.jsx("svg",{children:h.jsx("use",{href:`${re}#icon-arrow`})})]})]})]}),h.jsxs(Jo,{children:[h.jsx(Zo,{children:h.jsx("svg",{children:h.jsx("use",{href:`${re}#icon-run`})})}),h.jsx("h2",{children:t})]}),h.jsxs(ea,{children:[h.jsx("li",{children:h.jsxs("p",{children:["Calories:",h.jsx("span",{children:i})]})}),h.jsx("li",{children:h.jsxs(ta,{children:["Category:",h.jsx("span",{children:r})]})}),h.jsx("li",{children:h.jsxs("p",{children:["Weight:",h.jsx("span",{children:e})]})})]})]})]},n)},ia=M.ul`
  display: flex;
  flex-direction: column;
  gap: 20px;
  margin-bottom: 80px;
...
`,ra=n=>`${n[0].toUpperCase()}${n.slice(1)}`,oa=()=>{const n=Me(),t=z(un),i=z(st),r=z(lt),e=z(sn);console.log("blood",e);const a=z(ln);return z(cn),m.useEffect(()=>{n(dn({recommended:r.value,category:i.value,query:t}))},[r,i,t,n]),h.jsx(ia,{children:a.map(u=>h.jsx(na,{id:u._id,title:u.title,calories:u.calories,category:ra(u.category.name),weight:u.weight,recommended:e?!u.groupBloodNotAllowed[e]:!1},u._id))})},aa=W.div`
  margin-bottom: 40px;
