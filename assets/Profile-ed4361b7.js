import{s as i,a as Q,b as Z,u as Y,c as S,r as h,g as ee,j as e,d as g,e as te,l as re,f as ie,h as k,i as ne,k as ae,m as oe,n as se,S as de}from"./index-3fcba508.js";import{c as ce,a as C,b,d as le,F as T,e as pe,f as xe}from"./index.esm-b075f5c5.js";import{s as he,g as z,t as me,a as ge}from"./react-datepicker-519c4567.js";import{f as J}from"./createClass-4bb3c8ce.js";import{T as ue}from"./TitlePage-6829ca45.js";const fe=i.div`
  display: flex;
  gap: 14px;
...
`,Ur=i.button`
  ...
  color: #efede8;
  border-width: 0;
`,x={name:"",email:"",height:0,currentWeight:0,desiredWeight:0,blood:0,sex:"",levelActivity:0,birthday:"2004-11-14"},qr=()=>{const t=Y(),{userData:r}=S(a=>a.auth),{profile:n}=S(a=>a.profile),[o,c]=h.useState("2004-11-14");h.useEffect(()=>{t(ae())},[t]),h.useEffect(()=>{r&&(x.name=r.name,x.email=r.email),n&&(x.height=n.height,x.currentWeight=n.currentWeight,x.desiredWeight=n.desiredWeight,x.blood=String(n.blood),x.sex=n.sex,x.levelActivity=String(n.levelActivity),x.birthday=n.birthday,c(n.birthday))},[r,n,o]);const p=a=>{const{name:d,email:m,birthday:j,...f}=a,s={name:d},w={birthday:o,...f};t(oe(s)),t(se(w))},u=a=>{let d=J(a,"yyyy-dd-MM");c(d)};return e.jsx(pe,{initialValues:x,onSubmit:p,validationSchema:Le,enableReinitialize:!0,children:({errors:a,touched:d})=>e.jsxs(xe,{autoComplete:"off",children:[a.email&&d.email&&e.jsx(_,{children:a.email}),a.height&&d.height&&e.jsx(_,{children:a.height}),a.currentWeight&&d.currentWeight&&e.jsx(_,{children:a.currentWeight}),a.desiredWeight&&d.desiredWeight&&e.jsx(_,{children:a.desiredWeight}),e.jsx(Lr,{onDateChange:u}),e.jsx(Je,{}),e.jsx(Ur,{type:"submit",children:"Save"})]})})},Hr=()=>e.jsxs(de,{children:[e.jsx(ue,{children:"Profile Settings"}),e.jsxs(Ee,{children:[e.jsx(De,{}),e.jsx(qr,{})]})]});export{Hr as default};
