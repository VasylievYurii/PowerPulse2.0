...
`,ra=n=>`${n[0].toUpperCase()}${n.slice(1)}`,oa=()=>{const n=Me(),t=z(un);console.log("query:",t);const i=z(st);console.log("category:",i);const r=z(lt);console.log("recommended:",r);const e=z(sn);console.log("blood",e);const a=z(ln);return z(cn),m.useEffect(()=>{n(dn({recommended:r.value,category:i.value,query:t}))},[r,i,t,n]),h.jsx(ia,{children:a.map(u=>h.jsx(na,{id:u._id,title:u.title,calories:u.calories,category:ra(u.category.name),weight:u.weight,recommended:e?!u.groupBloodNotAllowed[e]:!1},u._id))})},aa=W.div`
  margin-bottom: 40px;
