...
`,go=N.div`
  display: flex;
  gap: 16px;
`,ct=[{value:"all",label:"All"},{value:"true",label:"Recommended "},{value:"false",label:"Not recommended"}],bo=()=>{const[n,t]=h.useState(""),[i,r]=h.useState({value:"all",label:"All categories"}),[e,a]=h.useState(ct[0]),u=Me();h.useEffect(()=>{u(dt({recommended:e.value,category:i.value,query:n}))},[e,i,n,u]),h.useEffect(()=>{u(Zt())},[u]);const l=p=>`${p[0].toUpperCase()}${p.slice(1)}`,o=ie(Qt),s=[{value:"all",label:"All categories"},...o.map(({_id:p,name:f})=>({value:p,label:l(f)}))],c=p=>{const{value:f}=p.target;t(f)},d=p=>{p.preventDefault();const f=p.target.elements[0].value;t(f)},v=()=>{t("")},b=p=>{r(p)},x=p=>{a(p)};return m.jsx(m.Fragment,{children:m.jsxs(co,{children:[m.jsx("form",{onSubmit:d,children:m.jsxs(lo,{children:[m.jsx(po,{type:"text",name:"productsSearch",placeholder:"Search",value:n,onChange:c}),n&&m.jsx(mo,{type:"button",onClick:v,children:m.jsx(vo,{children:m.jsx("use",{href:re+"#icon-cross"})})}),m.jsx(fo,{type:"submit",children:m.jsx(ho,{children:m.jsx("use",{href:re+"#icon-search"})})})]})}),m.jsxs(go,{children:[m.jsx(lt,{styles:uo,value:i,onChange:b,options:s,placeholder:"Categories",theme:p=>({...p,colors:{...p.colors,primary50:"rgba(255, 255, 255, 0.10)",primary:"transparent",neutral40:"#EFEDE8",neutral20:"transparent",neutral30:"transparent",neutral50:"rgba(239, 237, 232, 1)",neutral80:"rgba(239, 237, 232, 1)"}})}),m.jsx(lt,{styles:so,value:e,onChange:x,options:ct,theme:p=>({...p,colors:{...p.colors,primary50:"rgba(255, 255, 255, 0.10)",primary:"transparent",neutral40:"#EFEDE8",neutral20:"transparent",neutral30:"transparent",neutral50:"rgba(239, 237, 232, 1)",neutral80:"rgba(239, 237, 232, 1)"}})})]})]})})},xo=M.div`
  padding: 38px 22px;
`,Eo=M.div`
  margin-bottom: 16px;
  display: flex;
...
`,Mo=({id:n,title:t,calories:i,onClick:r,onClickSuccess:e})=>{const[a,u]=h.useState(0),l=Me(),o={product_id:n,date:mn(new Date,"yyyy-MM-dd"),weight:"",calories:0},s=bn().shape({product_id:Ue().required(),date:Ue().required(),weight:Ne().required().positive(),calories:Ne().required()}),c=x=>{const p=i*x/100;return parseFloat(p)},d=(x,p)=>{const f=x.target.value,g=c(f);u(g),p("weight",Number(f)),p("calories",g)},v=(x,p)=>{e(),l(tn(x)),p.resetForm(),r()},b=()=>{r()};return m.jsxs(m.Fragment,{children:[m.jsx(en,{}),m.jsx(xn,{initialValues:o,validationSchema:s,onSubmit:v,children:({values:x,setFieldValue:p})=>m.jsx(En,{autoComplete:"off",children:m.jsxs(xo,{children:[m.jsxs(Eo,{children:[m.jsx("div",{children:m.jsx("label",{htmlFor:"product",children:m.jsx(Co,{name:"product",type:"text",value:t,readOnly:!0})})}),m.jsx("div",{children:m.jsxs(So,{htmlFor:"amount",children:[m.jsx(Fo,{name:"amount",type:"text",onChange:f=>d(f,p),onKeyPress:f=>{/^[0-9\b]+$/.test(f.key)||f.preventDefault()},value:x.weight}),m.jsx(wo,{children:"grams"}),m.jsx(Cn,{name:"weight",component:"p"})]})})]}),m.jsxs(yo,{children:["Calories: ",m.jsx(Do,{children:a})]}),m.jsxs(Oo,{children:[m.jsx(Io,{type:"submit",children:"Add to diary"}),m.jsx(Ao,{type:"button",onClick:b,children:"Cancel"})]})]})})})]})},Vo=M.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Xo=!1,Jo=n=>`${n[0].toUpperCase()}${n.slice(1)}`,Zo=()=>{const n=Me(),t=ie(on);return h.useEffect(()=>{n(dt())},[n]),m.jsx(Ko,{children:t.map(i=>m.jsx(qo,{id:i._id,title:i.title,calories:i.calories,category:Jo(i.category.name),weight:i.weight,recommended:Xo},i._id))})},Qo=N.div`
  margin-bottom: 40px;
