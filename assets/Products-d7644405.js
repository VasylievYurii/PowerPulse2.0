...
`,$o=!1,jo=n=>`${n[0].toUpperCase()}${n.slice(1)}`,zo=()=>{const n=Me(),t=de(en);return m.useEffect(()=>{n(ct())},[n]),E.jsx(Ho,{children:t.map(i=>E.jsx(Bo,{id:i._id,title:i.title,calories:i.calories,category:jo(i.category.name),weight:i.weight,recommended:$o},i._id))})},Uo=N.div`
  margin-bottom: 40px;
...
`,Xo=()=>{const n=de(tn),t=de(nn);return E.jsx(rn,{children:E.jsxs(No,{children:[E.jsx(_o,{children:"Filters"}),E.jsx(Uo,{children:E.jsx(pn,{children:"Products"})}),E.jsx(mo,{}),n&&!t&&E.jsx(on,{}),E.jsx(zo,{})]})})};export{Xo as default};
