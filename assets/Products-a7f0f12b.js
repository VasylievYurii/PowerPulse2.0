...
`,$o=!1,jo=n=>`${n[0].toUpperCase()}${n.slice(1)}`,Uo=()=>{const n=Me(),t=de(Qt);return m.useEffect(()=>{n(lt())},[n]),E.jsx(Ho,{children:t.map(r=>E.jsx(Bo,{title:r.title,calories:r.calories,category:jo(r.category.name),weight:r.weight,recommended:$o},r._id))})},zo=K.div`
  position: relative;
`,qo=()=>{const n=de(en),t=de(tn);return E.jsxs(nn,{children:[E.jsx(dn,{children:"Products"}),E.jsxs(zo,{children:[E.jsx(mo,{}),n&&!t&&E.jsx(rn,{}),E.jsx(Uo,{})]})]})};export{qo as default};
