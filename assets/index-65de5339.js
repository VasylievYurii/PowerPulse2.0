...
`,J=s.img`
width: 118px;
`,K=({onClick:r})=>{const t=()=>{r()};return e.jsxs(G,{children:[e.jsx(J,{src:"../../assets/thumb_up_color.png",alt:"Thumb up"}),e.jsx(H,{children:"Well done"}),e.jsxs(D,{children:[e.jsxs(u,{children:["Your time: ",e.jsx("span",{children:"3 minutes"})]}),e.jsxs(u,{children:["Burned calories: ",e.jsx("span",{children:"250"})]})]}),e.jsx(_,{onClick:t,children:"Next Exercise"}),e.jsxs(U,{to:"/diary",children:["To the diary",e.jsx(F,{children:e.jsx("use",{href:`${g}#icon-arrow`})})]})]})},P=()=>{var j;b(x=>x.exercises),o.useState(!1);const r=v(),t=y(),n=o.useRef(((j=r.state)==null?void 0:j.from)??"/"),[c,m]=o.useState(!1),a=()=>{m(x=>!x)};return o.useEffect(()=>{t(w())},[t]),e.jsxs(e.Fragment,{children:[e.jsx(q,{}),e.jsxs(k,{children:[e.jsx(i,{to:n.current,children:e.jsx(z,{children:"Go Back"})}),e.jsx(S,{children:"Exercises"}),e.jsxs(W,{children:[e.jsx("li",{children:e.jsxs(i,{to:"bodyparts",children:[" ",e.jsx(l,{children:"Body parts"})]})}),e.jsx("li",{children:e.jsxs(i,{to:"muscles",children:[" ",e.jsx(l,{children:"Muscles"})]})}),e.jsx("li",{children:e.jsx(i,{to:"equipment",children:e.jsx(l,{children:"Equipment"})})})]}),e.jsxs(o.Suspense,{fallback:e.jsx("p",{children:"Loader"}),children:[e.jsx("button",{onClick:a,children:"Add to diary"}),c&&e.jsx(T,{onClick:a,children:e.jsx(K,{onClick:a})}),e.jsx(E,{})]})]})]})},Z=P;export{Z as default};
